...
const HeaderRight = (props) => {
  ...
  return (
    <div className=" w-[50%] lg:w-[15%]  h-[50px]  flex   justify-evenly items-center text-white   ">
      <div className="flex">
        <svg
        ...
        <div className="hidden lg:flex">signUp</div>
      </div>

      <div className="lg:hidden"  onClick={() => setIsOpenNav(!isOpenNav)}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
